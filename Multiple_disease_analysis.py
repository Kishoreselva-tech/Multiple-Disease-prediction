...
if selected_model == "Parkinson's Disease":
    ...
    model, error = load_model(r"C:\Users\kishore\parkinsons.pkl")
...
# Kidney Disease 
    ...
    model, error = load_model(r"C:\Users\kishore\kidney_disease.pkl")
...
# Liver model
    ...
    model, error = load_model(r"C:\Users\kishore\indian_liver_patient.pkl")
